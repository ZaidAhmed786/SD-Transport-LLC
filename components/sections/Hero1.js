                            ...
                            <div className="d-flex align-items-sm-center align-items-end justify-content-between">
                                <h1 className="white-clr text-uppercase">
                                    ...
                                    Enjoy the advantages of truckload shipping while only paying for the space you need
                                        {/* <span className="designers" data-text="ZOLARA" data-aos="zoom-in" data-aos-duration={2000}>SD Transport LLC</span> */}
                                    </span>
                                   ...
                                   <div className="gap-5 d-flex align-items-center  mt-5">
                                    <a href="/about"  className="fs-5 px-5  " style={{backgroundColor : "#e3ff04", color : "white", borderRadius: "50px", lineHeight: "50px" , border : "2px solid #e3ff04" }}>Start Shipping</a>
                                    <a href="/contact"  className="fs-5 px-5  " style={{ color : "white", borderRadius: "50px", lineHeight: "50px" , border : "2px solid white" }}>Start Hauling</a>
                                </div>
                                </h1>
